...
public class Medicament2Application {
	...
	public static void main(String[] args) {
		...
		MedicamentDaoItf m =  ctx.getBean(MedicamentDaoItf.class);		
		...
		medicament1 = m.save(medicament1);
		medicament2 = m.save(medicament2);
		medicament3 = m.save(medicament3);
		medicament4 = m.save(medicament4);
		/*
